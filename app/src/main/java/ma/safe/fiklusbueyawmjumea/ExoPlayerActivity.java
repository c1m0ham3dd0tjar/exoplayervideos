...
//        getSupportActionBar().hide();
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            DefaultRenderersFactory rf = new DefaultRenderersFactory(this, DefaultRenderersFactory.EXTENSION_RENDERER_MODE_ON);
            // 2. Create the player
            player =
                    ExoPlayerFactory.newSimpleInstance(this, rf,trackSelector,loadControl);
            /*player =
